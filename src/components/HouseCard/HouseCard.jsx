  ...
  return (
    <div className={styles["house-card"]}>
      <div className={styles["house-card__item"]}>
        <img src={image} />
        <div
          style={{ background: backgroundIco }}
          className={styles["house-card__icon"]}
        >
          <img src={imageIco} />
          <p
            style={{ color: colorIco }}
            className={styles["house-card__item-description"]}
          >
            {textIco}
          </p>
        </div>
      ...
      <div className={styles["house-card__salesman"]}>
        ...
        <div className={styles["salesman__details"]}>
          <h6 className={styles["salesman__details-title"]}>{nameSalesman}</h6>
          <p className={styles["salesman__details-description"]}>
            {description}
          </p>
        </div>
      </div>
