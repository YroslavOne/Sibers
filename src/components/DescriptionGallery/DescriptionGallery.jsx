...
function DescriptionGallery() {
  return (
    <div className={styles["description-gallery"]}>
      <div className={styles["description-gallery__name"]}>
        <div className={styles["description-gallery__name-line"]}></div>
        <p className={styles["description-gallery__name-p"]}>Ready to Sell!</p>
      </div>
      <div className={styles["description-gallery__information"]}>
        ...
        <div className={styles["description-gallery__detail"]}>
          ...
          <ul className={styles["gallery-detail__items"]}>
            {detailsList.map((detail, index) => (
              <li key={index} className={styles["gallery-detail__item"]}>
                <img
        ...
        <div className={styles["gallery-detail__line"]}></div>
        <div className={styles["description-gallery__manager"]}>
          <div className={styles["description-gallery__manager-div"]}>
          <img
          ...
          <button className={styles["manager-info__button"]}>
